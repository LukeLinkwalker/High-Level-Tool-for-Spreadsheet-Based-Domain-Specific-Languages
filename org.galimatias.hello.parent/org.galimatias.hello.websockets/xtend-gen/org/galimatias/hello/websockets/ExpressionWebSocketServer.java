...
public class ExpressionWebSocketServer extends WebSocketServer {
  public ByteArrayOutputStream out = new ByteArrayOutputStream() {
    ...
    public void flush() throws IOException {
      ...
      ExpressionWebSocketServer.this.conn.send(s);
      this.reset();
    }
  };
  ...
  public PipedInputStream in = new Function0<PipedInputStream>() {
    public PipedInputStream apply() {
      try {
        PipedInputStream _pipedInputStream = new PipedInputStream(ExpressionWebSocketServer.this.pipe);
  ...
  public ExpressionWebSocketServer(final InetSocketAddress a) {
    super(a);
  }
